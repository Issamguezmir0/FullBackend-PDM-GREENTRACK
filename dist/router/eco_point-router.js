...
const eco_pointController = __importStar(require("../controller/eco_point-controller"));
...
router.patch("/:eco_pointId", todoValidator, eco_pointController.updateEco_point);
